      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <Section id="codex" icon="🟣" title={dict.mcp.codex.title}>
          ...
          <Step n={2} title={dict.mcp.codex.step2Title}>
            <p className="text-gray-400 text-sm mb-3">
              {dict.mcp.codex.step2Body1} <strong className="text-white">{dict.mcp.codex.step2Body2}</strong> {dict.mcp.codex.step2Body3}
            </p>
            <CodeBlock code={'chat.mcp.enabled: true'} lang="text" />
            <p className="text-gray-400 text-sm mt-3">
              {dict.mcp.codex.step2Footer}
            </p>
          ...
          <Step n={3} title={dict.mcp.codex.step3Title}>
            <p className="text-gray-400 text-sm mb-3">
              {dict.mcp.codex.step3Body1} <strong className="text-white">{dict.mcp.codex.step3Body2}</strong> {dict.mcp.codex.step3Body3}
            </p>
          </Step>
        </Section>
