...
- [x] CF-GDB-03b-E — Retire Postgres tables + GraphSyncService (stop-point gated)
...
- [x] enh-output-gate-file-verdict — Verdetto output-gate scritto nel prompt file dall'Analyst (niente parsing stdout)
